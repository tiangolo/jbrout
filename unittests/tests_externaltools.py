...
assert splitCommandLine('  /bin/toto "ko ') == ['/bin/toto', 'ko']
...
assert splitCommandLine('  /bin/toto ko"ka ') == ['/bin/toto', 'ko"ka']

assert splitCommandLine('  /bin/toto " ko ka"ku ') is None
assert splitCommandLine('  /bin/toto ku" ko ka" ') is None
assert splitCommandLine('  /bin/toto " ko ka"-ku ') is None
assert splitCommandLine('  /bin/toto -ku" ko ka" ') is None
